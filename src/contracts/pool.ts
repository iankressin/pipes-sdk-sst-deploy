...
export const events = {
  ...
  IncreaseObservationCardinalityNext: event(
    ...
    {
      observationCardinalityNextOld: p.uint16,
      observationCardinalityNextNew: p.uint16,
    },
  ),
  Initialize: event(
...
export const functions = {
  ...
  feeGrowthGlobal0X128: viewFun(
    '0xf3058399',
    'feeGrowthGlobal0X128()',
    {},
    p.uint256,
  ),
  feeGrowthGlobal1X128: viewFun(
    '0x46141319',
  ...
  initialize: fun('0xf637731d', 'initialize(uint160)', {
    sqrtPriceX96: p.uint160,
  }),
  liquidity: viewFun('0x1a686502', 'liquidity()', {}, p.uint128),
  maxLiquidityPerTick: viewFun(
    '0x70cf754a',
    'maxLiquidityPerTick()',
    {},
    p.uint128,
  ...
  observe: viewFun(
    ...
    {
      tickCumulatives: p.array(p.int56),
      secondsPerLiquidityCumulativeX128s: p.array(p.uint160),
    },
  ),
  positions: viewFun(
    '0x514ea4bf',
...
export class Contract extends ContractBase {
  ...
  snapshotCumulativesInside(
    ...
    return this.eth_call(functions.snapshotCumulativesInside, {
      tickLower,
      tickUpper,
    })
  }
...
export type CollectProtocolParams = FunctionArguments<
  typeof functions.collectProtocol
>
export type CollectProtocolReturn = FunctionReturn<
  typeof functions.collectProtocol
>
...
export type FeeGrowthGlobal0X128Params = FunctionArguments<
  typeof functions.feeGrowthGlobal0X128
>
export type FeeGrowthGlobal0X128Return = FunctionReturn<
  typeof functions.feeGrowthGlobal0X128
>

export type FeeGrowthGlobal1X128Params = FunctionArguments<
  typeof functions.feeGrowthGlobal1X128
>
export type FeeGrowthGlobal1X128Return = FunctionReturn<
  typeof functions.feeGrowthGlobal1X128
>
...
export type MaxLiquidityPerTickParams = FunctionArguments<
  typeof functions.maxLiquidityPerTick
>
export type MaxLiquidityPerTickReturn = FunctionReturn<
  typeof functions.maxLiquidityPerTick
>
...
export type ObservationsParams = FunctionArguments<
  typeof functions.observations
>
...
export type ProtocolFeesParams = FunctionArguments<
  typeof functions.protocolFees
>
export type ProtocolFeesReturn = FunctionReturn<typeof functions.protocolFees>

export type SetFeeProtocolParams = FunctionArguments<
  typeof functions.setFeeProtocol
>
export type SetFeeProtocolReturn = FunctionReturn<
  typeof functions.setFeeProtocol
>
